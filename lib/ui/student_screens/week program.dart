...
class WeekProgram extends StatefulWidget {
  const WeekProgram({super.key});

  @override
  State<WeekProgram> createState() => _WeekProgramState();
}

class _WeekProgramState extends State<WeekProgram>
