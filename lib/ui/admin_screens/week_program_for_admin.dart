...
class WeekProgramForAdmin extends StatefulWidget {
  const WeekProgramForAdmin({super.key});

  @override
  State<WeekProgramForAdmin> createState() => _WeekProgramForAdminState();
}

class _WeekProgramForAdminState extends State<WeekProgramForAdmin>
